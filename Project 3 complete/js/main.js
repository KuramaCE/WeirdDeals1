...
let requestURL = "https://kuramace.github.io/WeirdDeals1/js/products.json";
...
function deals(jsonObj) {
  ...
  for (let i = 0; i < deals.length; i++) {
    ...
    img.setAttribute('src', ' https://kuramace.github.io/WeirdDeals1/js/products.json' + deals[i].image);
